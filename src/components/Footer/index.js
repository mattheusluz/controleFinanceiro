      ...
      <div className="authors">
        <div className="names border">
          ...
          <div className="linkHub">
            <a href="https://github.com/AdelinoJonas" target={'blank'}>
              <img src={github} alt="Jonas's gitHub link" />
            </a>
            <a href="https://www.linkedin.com/in/jonas-adelino-168830179/" target={'blank'}>
        ...
        <div className="names">
          ...
          <div className="linkHub">
            <a href="https://github.com/mattheusluz" target={'blank'}>
              <img
                src={github}
                alt="Matheus's gitHub link"
              />
            </a>
            <a href="https://www.linkedin.com/in/mattheusluz/" target={'blank'}>
